...
/***/ function(module, exports, __webpack_require__) {
	...
	var flightEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var signInApi = __webpack_require__(8);

	var signUpSuccess = function signUpSuccess(data) {
	  var password = $('#sign-up-pw').val();
	  signInApi.autoSignIn(data.user.email, password).done(signInSuccess).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var autoSignIn = function autoSignIn(email, password) {
	  return $.ajax({
	    url: app.host + '/sign-in',
	    method: "POST",
	    data: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateFlight = function onCreateFlight(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createFlight(data).done(ui.createFlightSuccess).fail(ui.failure);
	};

	var onFutureFlight = function onFutureFlight(event) {
	  $('.search-flight-content').text('');
	  $('.future-flight-content').text('');
	  $('.past-flight-content').text('');
	  event.preventDefault();
	  api.getFlight().done(ui.getFutureFlightSuccess).fail(ui.failure);
	};

	var onPastFlight = function onPastFlight(event) {
	  $('.search-flight-content').text('');
	  $('.future-flight-content').text('');
	  $('.past-flight-content').text('');
	  event.preventDefault();
	  api.getFlight().done(ui.getPastFlightSuccess).fail(ui.failure);
	};

	var onEditFlight = function onEditFlight(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.updateFlight(data).done(ui.updateFlightsuccess).fail(ui.failure);
	};

	var onDeleteFlight = function onDeleteFlight(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteFlight(data).done(ui.deleteSuccess).fail(ui.failure);
	};

	var onSearchFlight = function onSearchFlight(event) {
	  $('.search-flight-content').text('');
	  $('.future-flight-content').text('');
	  $('.past-flight-content').text('');
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.searchFlight(data).done(ui.searchSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFlight = function createFlight(data) {
	  return $.ajax({
	...
	var getFlight = function getFlight() {
	  return $.ajax({
	    url: app.host + '/trips',
	    method: 'GET',
	    headers: {
	...
	var updateFlight = function updateFlight(data) {
	  var arr = ui.returnTripsArr();
	  console.log(data);
	  console.log(arr);
	...
	var deleteFlight = function deleteFlight(data) {
	  var arr = ui.returnTripsArr();
	  for (var i = 0; i < arr.length; i++) {
	    var trip = arr[i];
	...
	var searchFlight = function searchFlight(data) {
	  return $.ajax({
	    url: app.host + '/flights',
	    method: 'GET',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var addTripApi = __webpack_require__(12);
	...
	var createFlightSuccess = function createFlightSuccess(data) {
	  $('.input-field').val('');
	  $('.search-flight-content').text('');
	  $('.future-flight-content').text('');
	  $('.past-flight-content').text('');
	...
	var getFutureFlightSuccess = function getFutureFlightSuccess(data) {
	  var tripListing = __webpack_require__(13);
	  var weatherListing = __webpack_require__(33);
	  var userId = app.user.id;
	  tripArr = data.trips;

	  var _loop = function _loop(i) {
	    var each = tripArr[i];
	    var departureDate = new Date(each.flight.departure_date);
	    var today = new Date();
	    if (each.user.id === userId && departureDate >= today) {
	      ...
	      $('#weather-' + each.flight.id.toString()).on('click', function () {
	        addTripApi.addWeather(each.flight.arrival).done(function (data) {
	...
	var getPastFlightSuccess = function getPastFlightSuccess(data) {
	  var tripListing = __webpack_require__(13);
	  var weatherListing = __webpack_require__(33);
	  var userId = app.user.id;
	  tripArr = data.trips;
	...
	var updateFlightsuccess = function updateFlightsuccess() {
	  console.log("success!");
	  $('.input-field').val('');
	};
	...
	var searchSuccess = function searchSuccess(data) {
	  var searchFlightListing = __webpack_require__(34);
	  var typeFlightNumber = $('#search-flight-number').val();
	  var flightArr = data.flights;

	  var _loop3 = function _loop3(i) {
	    var each = flightArr[i];
	    if (each.flight_number === typeFlightNumber) {
	      ...
	      $('#add-trip-' + each.id.toString()).on('click', function () {
	        var flightId = $('#trip-flight-' + each.id.toString()).val();
	        addTripApi.addFlight(app.user.id, flightId).done(createFlightSuccess).fail(failure);
	      });
	    }
	  };
	...
	var returnTripsArr = function returnTripsArr() {
	  return tripArr;
	};

	module.exports = {
	  failure: failure,
	  createFlightSuccess: createFlightSuccess,
	  getFutureFlightSuccess: getFutureFlightSuccess,
	  getPastFlightSuccess: getPastFlightSuccess,
	  updateFlightsuccess: updateFlightsuccess,
	  deleteSuccess: deleteSuccess,
	  searchSuccess: searchSuccess,
	  returnTripsArr: returnTripsArr
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addFlight = function addFlight(userId, flightId) {
	  return $.ajax({
	    url: app.host + '/trips',
	    method: "POST",
	    data: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"container col-md-4\">\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <div class=\"btn-group\" style=\"float:left;\">\n              <h4 class=\"media-heading\">Flight Info</h4>\n            </div>\n              <div class=\"btn-group\" style=\"float:right;\">\n                <button type=\"button\"  id=\"weather-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"btn btn-info dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n                  Weather Info\n                </button>\n                <div class=\"dropdown-menu weather-button weather-container-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n                </div>\n              </div>\n            <div class=\"clearfix\"></div>\n        </div>\n        <div class=\"panel-body\">\n            <div class=\"media\">\n                <div class=\"media-body\">\n                  <p> Flight Number: "
	    + alias2(((helper = (helper = helpers.flight_number || (depth0 != null ? depth0.flight_number : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"flight_number","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Departure Date: "
	    + alias2(((helper = (helper = helpers.departure_date || (depth0 != null ? depth0.departure_date : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"departure_date","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Departure Time: "
	    + alias2(((helper = (helper = helpers.departure_time || (depth0 != null ? depth0.departure_time : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"departure_time","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Departure: "
	    + alias2(((helper = (helper = helpers.departure || (depth0 != null ? depth0.departure : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"departure","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Arrival Date: "
	    + alias2(((helper = (helper = helpers.arrival_date || (depth0 != null ? depth0.arrival_date : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"arrival_date","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Arrival Time: "
	    + alias2(((helper = (helper = helpers.arrival_time || (depth0 != null ? depth0.arrival_time : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"arrival_time","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Arrival: "
	    + alias2(((helper = (helper = helpers.arrival || (depth0 != null ? depth0.arrival : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"arrival","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Arrival ZipCode: "
	    + alias2(((helper = (helper = helpers.arrival_zipcode || (depth0 != null ? depth0.arrival_zipcode : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"arrival_zipcode","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Gate: "
	    + alias2(((helper = (helper = helpers.gate || (depth0 != null ? depth0.gate : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"gate","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Terminal: "
	    + alias2(((helper = (helper = helpers.terminal || (depth0 != null ? depth0.terminal : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"terminal","hash":{},"data":data}) : helper)))
	    + " </p>\n                <div class=\"clearfix\"></div>\n               </div>\n            </div>\n        </div>\n    </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"col-xs-18 col-sm-6 col-md-6 weather-box\">\n  <div class=\"thumbnail\" style=\"border: none;\">\n    <p> "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"container col-md-4\">\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <div class=\"btn-group\" style=\"float:left;\">\n              <h4 class=\"media-heading\">Flight Info</h4>\n            </div>\n            <div class=\"btn-group\" style=\"float:right;\">\n              <form id=\"search-flight-info\">\n                <fieldset>\n                  <input id=\"trip-flight-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" type=\"hidden\" name=\"trip[flight_id]\" value="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n                  <button id=\"add-trip-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" type=\"button\" class=\"btn btn-default\">Add to my Trips</button>\n                </fieldset>\n              </form>\n            </div>\n            <div class=\"clearfix\"></div>\n        </div>\n        <div class=\"panel-body\">\n            <div class=\"media\">\n                <div class=\"media-body\">\n                  <p> Flight Number: "
	    + alias4(((helper = (helper = helpers.flight_number || (depth0 != null ? depth0.flight_number : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"flight_number","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Departure Date: "
	    + alias4(((helper = (helper = helpers.departure_date || (depth0 != null ? depth0.departure_date : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"departure_date","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Departure Time: "
	    + alias4(((helper = (helper = helpers.departure_time || (depth0 != null ? depth0.departure_time : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"departure_time","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Departure: "
	    ...
	    + " </p>\n                  <p> Arrival Date: "
	    + alias4(((helper = (helper = helpers.arrival_date || (depth0 != null ? depth0.arrival_date : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"arrival_date","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Arrival Time: "
	    + alias4(((helper = (helper = helpers.arrival_time || (depth0 != null ? depth0.arrival_time : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"arrival_time","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Arrival: "
	    ...
	    + " </p>\n                  <p> Arrival ZipCode: "
	    + alias4(((helper = (helper = helpers.arrival_zipcode || (depth0 != null ? depth0.arrival_zipcode : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"arrival_zipcode","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Gate: "
	    + alias4(((helper = (helper = helpers.gate || (depth0 != null ? depth0.gate : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"gate","hash":{},"data":data}) : helper)))
	    + " </p>\n                  <p> Terminal: "
	    + alias4(((helper = (helper = helpers.terminal || (depth0 != null ? depth0.terminal : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"terminal","hash":{},"data":data}) : helper)))
	    + " </p>\n                <div class=\"clearfix\"></div>\n               </div>\n            </div>\n        </div>\n    </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "3cbd5eca4515287b5655f70c6c5690f7.jpeg";
